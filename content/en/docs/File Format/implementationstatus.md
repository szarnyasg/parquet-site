...
| Data type                                 | C++   | Java  | Go    | Rust  | cuDF  | DuckDB |
| ----------------------------------------- | ----- | ----- | ----- | ----- | ----- | ------ |
| BOOLEAN                                   |  ✅   |  ✅   |       |  ✅   |  ✅   |  ✅   |
| INT32                                     |  ✅   |  ✅   |       |  ✅   |  ✅   |  ✅   |
| INT64                                     |  ✅   |  ✅   |       |  ✅   |  ✅   |  ✅   |
...
| Encoding                                  | C++   | Java  | Go    | Rust  | cuDF  | DuckDB |
| ----------------------------------------- | ----- | ----- | ----- | ----- | ----- | ------ |
| PLAIN                                     |  ✅   |  ✅   |       |  ✅   |  ✅   |   ✅   |
| PLAIN_DICTIONARY                          |  ✅   |  ✅   |       |  ✅   |  ✅   |  (R)   |
| RLE_DICTIONARY                            |  ✅   |  ✅   |       |  ✅   |  ✅   |   ✅   |
...
| Compression                               | C++   | Java  | Go    | Rust  | cuDF  | DuckDB |
| ----------------------------------------- | ----- | ----- | ----- | ----- | ----- | ------ |
| UNCOMPRESSED                              |  ✅   |  ✅   |       |  ✅   |  ✅   |    ✅   |
| BROTLI                                    |  ✅   |  ✅   |       |  ✅   |  (R)  |    ✅   |
| GZIP                                      |  ✅   |  ✅   |       |  ✅   |  (R)  |    ✅   |
...
| Format                                       | C++   | Java  | Go    | Rust  | cuDF  | DuckDB |
| -------------------------------------------- | ----- | ----- | ----- | ----- | ----- | ------ |
